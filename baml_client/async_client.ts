    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          const __stream__ = this.stream.CategorizeMessage(
          role,from,subject,body,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.TriageResult
            } catch (error) {
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (__options__.onTick) {
          const __stream__ = this.stream.DetectIntent(
          user_message,inbox_summary,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.IntentResult
            } catch (error) {
            throw toBamlError(error);
            }
            }
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (__options__.onTick) {
          const __stream__ = this.stream.ReviseDraft(
          original_from,original_subject,current_draft,edit_instructions,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            role: string,from: string,subject: string,body: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.TriageResult, types.TriageResult>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for CategorizeMessage", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.TriageResult, types.TriageResult>(
                  __raw__,
                  (a): partial_types.TriageResult => a,
                  (a): types.TriageResult => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
            ...
            user_message: string,inbox_summary: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.IntentResult, types.IntentResult>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for DetectIntent", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.IntentResult, types.IntentResult>(
                  __raw__,
                  (a): partial_types.IntentResult => a,
                  (a): types.IntentResult => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
            ...
            __baml_options__?: BamlCallOptions<never>
              ...
              console.error("Error in onTick callback for ReviseDraft", error);
              }
              }
              };
              }
