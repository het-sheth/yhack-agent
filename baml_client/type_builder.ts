...
export default class TypeBuilder {
    ...
    IntentResult: ClassViewer<'IntentResult', "intent" | "search_query" | "response">;
    
    TriageResult: ClassViewer<'TriageResult', "category" | "score" | "gist" | "draft_reply">;
    
    
    Category: EnumViewer<'Category', "URGENT" | "ACTION_REQUIRED" | "FYI" | "LOW_PRIORITY">;
    
    Intent: EnumViewer<'Intent', "CHECK_INBOX" | "SEARCH_MESSAGE" | "GREETING" | "OTHER">;
    

    constructor() {
        this.tb = new _TypeBuilder({
          classes: new Set([
            "IntentResult","TriageResult",
          ]),
          enums: new Set([
            "Category","Intent",
          ]),
        ...
        this.IntentResult = this.tb.classViewer("IntentResult", [
          "intent","search_query","response",
        ]);
        
        this.TriageResult = this.tb.classViewer("TriageResult", [
          "category","score","gist","draft_reply",
        ]);
        
        
        this.Category = this.tb.enumViewer("Category", [
          "URGENT","ACTION_REQUIRED","FYI","LOW_PRIORITY",
        ]);
        
        this.Intent = this.tb.enumViewer("Intent", [
          "CHECK_INBOX","SEARCH_MESSAGE","GREETING","OTHER",
        ]);
